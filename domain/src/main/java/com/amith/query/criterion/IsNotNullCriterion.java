 ...
 * 
 */
public class IsNotNullCriterion implements QueryCriterion {

	private String propName;

	public IsNotNullCriterion(String propName) {
		if (StringUtils.isEmpty(propName)) {
			throw new QueryException("IsNotNullCriterion propName is null!");
		}
